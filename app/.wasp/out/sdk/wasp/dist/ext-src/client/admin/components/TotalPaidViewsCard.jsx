...
const TotalPageViewsCard = ({ totalPageViews, prevDayViewsChangePercent }) => {
    ...
    return (<div className='rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark'>
      ...
      <div className='mt-4 flex items-end justify-between'>
        ...
        {prevDayViewsChangePercent && parseInt(prevDayViewsChangePercent) !== 0 && (<span className={`flex items-center gap-1 text-sm font-medium ${isDeltaPositive ? 'text-meta-3' : 'text-meta-5'}`}>
