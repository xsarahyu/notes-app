...
const UsersTable = () => {
    ...
    const [hasPaidFilter, setHasPaidFilter] = useState(undefined);
          ...
          <div className='flex items-center justify-between gap-3 w-full px-2'>
            ...
            setEmail(e.currentTarget.value);
              ...
              <div className='flex-grow relative z-20 rounded border border-stroke pr-8 outline-none bg-white transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input'>
                ...
                <select onChange={(e) => {
            setStatusOptions((prevValue) => {
                if (prevValue === null || prevValue === void 0 ? void 0 : prevValue.includes(e.target.value)) {
                    return prevValue === null || prevValue === void 0 ? void 0 : prevValue.filter((val) => val !== e.target.value);
                }
                else if (!!prevValue) {
            ...
            if (!statusOptions.includes(status)) {
              ...
              <div className='flex items-center gap-2'>
                ...
                <select name='hasPaid-filter' onChange={(e) => {
