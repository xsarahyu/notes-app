...
const RevenueAndProfitChart = ({ weeklyStats, isLoading }) => {
    const dailyRevenueArray = useMemo(() => {
        if (!!weeklyStats && (weeklyStats === null || weeklyStats === void 0 ? void 0 : weeklyStats.length) > 0) {
            const sortedWeeks = weeklyStats === null || weeklyStats === void 0 ? void 0 : weeklyStats.sort((a, b) => {
    ...
    const daysOfWeekArr = useMemo(() => {
        if (!!weeklyStats && (weeklyStats === null || weeklyStats === void 0 ? void 0 : weeklyStats.length) > 0) {
            const datesArr = weeklyStats === null || weeklyStats === void 0 ? void 0 : weeklyStats.map((stat) => {
        ...
        if (dailyRevenueArray && dailyRevenueArray.length > 0) {
            setState((prevState) => {
                ...
                if (existingSeriesIndex >= 0) {
                    ...
                    return Object.assign(Object.assign({}, prevState), { series: prevState.series.map((serie, index) => {
                            if (index === existingSeriesIndex) {
                                return Object.assign(Object.assign({}, serie), { data: dailyRevenueArray });
                            }
                            return serie;
                        }) });
                }
                    ...
                    return Object.assign(Object.assign({}, prevState), { series: [
                            ...prevState.series,
                            {
                                name: 'Revenue',
    ...
    useEffect(() => {
        if (!!daysOfWeekArr && (daysOfWeekArr === null || daysOfWeekArr === void 0 ? void 0 : daysOfWeekArr.length) > 0 && !!dailyRevenueArray && (dailyRevenueArray === null || dailyRevenueArray === void 0 ? void 0 : dailyRevenueArray.length) > 0) {
            setChartOptions(Object.assign(Object.assign({}, options), { xaxis: Object.assign(Object.assign({}, options.xaxis), { categories: daysOfWeekArr }), yaxis: Object.assign(Object.assign({}, options.yaxis), { 
                    // get the min & max values to the neareast hundred 
                    max: Math.ceil(Math.max(...dailyRevenueArray) / 100) * 100, min: Math.floor(Math.min(...dailyRevenueArray) / 100) * 100 }) }));
        }
