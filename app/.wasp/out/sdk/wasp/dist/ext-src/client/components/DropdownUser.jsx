...
const DropdownUser = ({ user }) => {
    ...
    return (<div className='relative'>
      <button ref={trigger} onClick={toggleDropdown} className='flex items-center gap-4 duration-300 ease-in-out text-gray-900 hover:text-yellow-500'>
        ...
        <svg className={`hidden fill-current dark:fill-white sm:block ${dropdownOpen ? 'rotate-180' : ''}`} width='12' height='8' viewBox='0 0 12 8' fill='none' xmlns='http://www.w3.org/2000/svg'>
      ...
      {/* <!-- Dropdown --> */}
      <div ref={dropdown} className={`absolute right-0 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark dark:text-white ${dropdownOpen === true ? 'block' : 'hidden'}`}>
