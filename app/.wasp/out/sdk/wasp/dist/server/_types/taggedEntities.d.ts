import { type Entity, type EntityName, type User, type GptResponse, type Task, type File, type ContactFormMessage, type DailyStats, type PageViewSource, type Logs } from 'wasp/entities';
...
export type _Entity = _User | _GptResponse | _Task | _File | _ContactFormMessage | _DailyStats | _PageViewSource | _Logs | never;
